_emt.directive('menuToggle', ['$timeout', '$mdUtil', function($timeout, $mdUtil) {
    return {
        scope: {
            section: '='
        },
        templateUrl: 'common/directive/menu-toggle/menu-toggle.tmpl.html',
                ...
                $scope.$watch(
                    ...
                    function(open) {
                        ...
                        $mdUtil.nextTick(function() {
                            ...
                            var emtMenuContent = document.querySelector('.emt-menu').parentNode;
                            ...
                            $timeout(function() {
                                ...
                                if (open && $li && $li.offsetParent && $ul[0].scrollTop === 0) {
                                    $timeout(function() {
                                        ...
                                        $mdUtil.animateScrollTo(emtMenuContent, newScrollTop);
                                    }, 350, false);
                                }
                            }, 0, false);
